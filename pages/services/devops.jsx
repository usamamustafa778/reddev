        ...
        <Container className="relative py-16 md:py-20">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-2xl border border-gray-200/50 mb-6 shadow-sm">
              ...
              <span className="text-red-600 text-sm font-semibold">Continuous Delivery</span>
            </div>
            ...
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto mb-10">
              We bridge the gap between development and operations to accelerate your release cycles and ensure 99.9% uptime.
            </p>
            ...
            >
              <span className="font-bold">Scale Your Infrastructure</span>
          ...
          >
            {[
              { title: "CI/CD Pipelines", desc: "Automate building, testing, and deployment for faster shipping.", icon: LuInfinity, color: "from-red-500 to-red-600" },
              { title: "Cloud Management", desc: "AWS, Azure, and GCP optimization for maximum efficiency.", icon: LuCloud, color: "from-orange-500 to-red-500" },
              { title: "Infrastructure as Code", desc: "Manage your servers with Terraform and Ansible automation.", icon: LuTerminal, color: "from-red-600 to-orange-600" },
            ].map((feature, index) => (
              <motion.div
                key={index}
                variants={fadeInUp}
          ...
          >
            ...
            <div className="overflow-hidden w-full h-[550px] relative">
              ...
              >
                <Image
                  ...
                  src="https://images.unsplash.com/photo-1667372393119-3d4c48d07fc9?q=80&w=2070"
            ...
            <div className="absolute bottom-0 left-0 p-10 md:p-16 z-30 w-full">
              ...
              >
                <LuSettings2 className="text-red-500 w-5 h-5" />
                <span className="text-red-500 uppercase tracking-[0.2em] text-xs font-black">Scalable Architecture</span>
              </motion.div>
              
              <h3 className="text-white text-3xl md:text-5xl font-bold mb-8 max-w-2xl leading-[1.1]">
                Accelerate your growth with automated infrastructure.
              </h3>
