        ...
        <Container className="relative py-16 md:py-20">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-2xl border border-gray-200/50 mb-6 shadow-sm">
              ...
              <span className="text-red-600 text-sm font-semibold">Creative Excellence</span>
            </div>

            <h2 className="text-4xl md:text-5xl font-bold leading-[1.2] mb-8 text-slate-900">
              Crafting Immersive and{" "}
            ...
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto mb-10">
              We combine aesthetic beauty with functional precision to create digital products that users love to interact with.
            </p>
            ...
            >
              <span className="font-bold">Elevate Your Design</span>
          ...
          >
            {[
              { title: "Visual Identity", desc: "Creating unique brand languages and design systems.", icon: LuPalette, color: "from-red-500 to-red-600" },
              { title: "User Research", desc: "Data-driven insights to understand user behavior.", icon: LuFingerprint, color: "from-orange-500 to-red-500" },
              { title: "Interactive Prototypes", desc: "High-fidelity clickable designs in Figma and Adobe XD.", icon: LuMousePointer2, color: "from-red-600 to-orange-600" },
            ].map((feature, index) => (
              <motion.div
                key={index}
                variants={fadeInUp}
          ...
          {/* Smooth Transition Banner Section */}
          <motion.div 
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 p-10 md:p-16 z-30 w-full">
              ...
              >
                <LuPenTool className="text-red-500 w-5 h-5" />
                <span className="text-red-500 uppercase tracking-[0.2em] text-xs font-black">Pixel Perfect Design</span>
              </motion.div>
