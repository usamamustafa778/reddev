...
export default function Cybersecurity() {
  ...
  return (
    <>
      ...
      <FullContainer className="relative overflow-hidden bg-gradient-to-br from-slate-50 to-gray-100 pt-24">
        ...
        <Container className="relative py-16 md:py-20">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-2xl border border-gray-200/50 mb-6 shadow-sm">
              <LuShieldAlert className="text-red-600 w-5 h-5" />
              <span className="text-red-600 text-sm font-semibold">Fortified Protection</span>
            </div>
            ...
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto mb-10">
              Safeguard your digital assets against evolving threats. From penetration testing to 24/7 monitoring, we ensure your business remains bulletproof.
            </p>
            ...
            >
              <span className="font-bold">Get a Security Audit</span>
          ...
          >
            {[
              { title: "Threat Monitoring", desc: "Real-time surveillance to detect and neutralize risks instantly.", icon: LuActivity, color: "from-red-500 to-red-600" },
              { title: "Penetration Testing", desc: "Ethical hacking to find and fix vulnerabilities before they reach you.", icon: LuTerminal, color: "from-orange-500 to-red-500" },
              { title: "Data Encryption", desc: "Military-grade encryption for all your sensitive communications.", icon: LuLock, color: "from-red-600 to-orange-600" },
            ].map((feature, index) => (
              <motion.div
                key={index}
                variants={fadeInUp}
          ...
          {/* New Banner Section with Clear Text */}
          <motion.div 
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 p-10 md:p-16 z-30 w-full">
              <div className="flex items-center gap-3 mb-6">
                <LuEyeOff className="text-red-500 w-5 h-5 shadow-sm" />
                <span className="text-red-500 uppercase tracking-[0.2em] text-xs font-black drop-shadow-md">Secure Operations</span>
              </div>
              
              <h3 className="text-white text-3xl md:text-5xl font-bold mb-8 max-w-2xl leading-[1.1] drop-shadow-lg">
                Your security is our priority. We guard your digital frontier.
              </h3>
