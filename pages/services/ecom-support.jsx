...
export default function EcomMaintenance() {
  const fadeInUp = {
  ...
  return (
    <>
      ...
      <FullContainer className="relative overflow-hidden bg-gradient-to-br from-slate-50 to-blue-50/20 pt-24">
        {/* Support Grid Pattern */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#00000005_1px,transparent_1px),linear-gradient(to_bottom,#00000005_1px,transparent_1px)] bg-[size:30px_30px]"></div>
        ...
        <Container className="relative py-16 md:py-20">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-2xl border border-gray-200/50 mb-6 shadow-sm">
              <LuLifeBuoy className="text-red-600 w-5 h-5" />
              <span className="text-red-600 text-sm font-semibold">24/7 Technical Support</span>
            </div>
            ...
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto mb-10">
              Stop worrying about downtime or bugs. Our expert team provides continuous monitoring, security updates, and performance tuning for your e-commerce platform.
            </p>
            ...
            >
              <span className="font-bold">Get Support Now</span>
          ...
          >
            {[
              { title: "Security Patches", desc: "Regular updates to protect your store from new vulnerabilities and threats.", icon: LuShieldCheck, color: "from-red-500 to-red-600" },
              { title: "Speed Optimization", desc: "Constant performance monitoring to ensure lightning-fast loading times.", icon: LuGauge, color: "from-orange-500 to-red-500" },
              { title: "Database Care", desc: "Routine backups and optimization to keep your customer data safe and accessible.", icon: LuDatabase, color: "from-red-600 to-orange-600" },
            ].map((feature, index) => (
              <motion.div
                key={index}
                variants={fadeInUp}
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 p-10 md:p-16 z-30 w-full">
              <div className="flex items-center gap-3 mb-6">
                <LuCloudLightning className="text-red-500 w-5 h-5 shadow-sm" />
                <span className="text-red-500 uppercase tracking-[0.2em] text-xs font-black drop-shadow-md">99.9% Uptime Commitment</span>
              </div>
              
              <h3 className="text-white text-3xl md:text-5xl font-bold mb-8 max-w-2xl leading-[1.1] drop-shadow-lg">
                Your business never sleeps, and neither does our support.
              </h3>
