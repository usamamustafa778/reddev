...
export default function Hero({
  heading1 = "Next-Gen Digital Solutions. Built to Scale.",
      ...
      <Container className="relative z-10">
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 text-center md:text-left py-20 md:py-32 pt-32 md:pt-44 gap-16 md:gap-20 items-center">
          ...
          <div className="flex-1 space-y-8 md:space-y-10 flex flex-col justify-center">
            ...
            >
              Custom web and mobile applications designed to transform your ideas into high-performance digital product
            </motion.p>
            ...
            >
              <div className="flex items-center gap-2.5">
                ...
                <span className="font-medium">Full-Stack Excellence</span>
              </div>
              <div className="flex items-center gap-2.5">
                <svg className="w-5 h-5 text-red-500" fill="currentColor" viewBox="0 0 20 20">
